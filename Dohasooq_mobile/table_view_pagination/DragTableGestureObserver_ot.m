...
@implementation DragTableGestureObserver_ot
{
    ...
    __unsafe_unretained UICollectionView *_tableView;
}

- (id)initWithObservingTableView:(UICollectionView *)tableView delegate:(id<DragTableGestureObserverDelegate_ot>)delegate
{
    self = [super init];
    if (self)
    {
