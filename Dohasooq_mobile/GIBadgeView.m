...
static CGFloat const kBadgeViewMinimumSize = 15.0;
static CGFloat const kBadgeViewPadding = 5.0;
static CGFloat const kBadgeViewDefaultFontSize = 9.0;
...
- (void)setupDefaultAppearance {
    ...
    self.hidden = YES;
    self.backgroundColor = [UIColor colorWithRed:0.99 green:0.68 blue:0.16 alpha:1.0];
