...
//    [self.scrollView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-0-[segmentedControl]-0-|"
//                                                                      options:0
//                                                                      metrics:nil
//                                                                        views:@{@"segmentedControl": self.maskView}]];
//    [self.scrollView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[segmentedControl]-0-|"
//                                                                      options:0
//                                                                      metrics:nil
//                                                                        views:@{@"segmentedControl": self.maskView}]];
}
...
- (NSDictionary *)resultingTitleTextAttributes {
    NSDictionary *defaults = @{
        NSFontAttributeName : [UIFont fontWithName:@"HelveticaNeue-Medium" size:19.0f],
