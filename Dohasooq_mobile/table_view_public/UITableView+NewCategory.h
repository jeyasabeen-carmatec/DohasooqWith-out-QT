...
- (void)dragTableDidTriggerRefresh:(UICollectionView *)tableView;
...
- (void)dragTableRefreshCanceled:(UICollectionView *)tableView;

//Called when table trigger a load more event.
- (void)dragTableDidTriggerLoadMore:(UICollectionView *)tableView;
...
- (void)dragTableLoadMoreCanceled:(UICollectionView *)tableView;
...
@property (nonatomic, readonly) id<UICollectionViewDragDelegate> dragDelegate;
...
//Sub controls
@property (nonatomic, readonly) DGActivityIndicatorView *headerLoadingIndicator;
@property (nonatomic, readonly) DGActivityIndicatorView *footerLoadingIndicator;
