...
@interface UICollectionView(DragRefreshAndLoadPrivate)
...
@interface UICollectionView(DragRefreshAndLoadCallback)<DragTableHeaderDelegate_ot, DragTableFooterDelegate_ot, DragTableGestureObserverDelegate_ot>

@end

@implementation UICollectionView(DragRefreshAndLoadCallback)
...
@implementation UICollectionView (DragLoad)
...
- (void)setDragDelegate:(id<UICollectionViewDragDelegate>)dragDelegate refreshDatePermanentKey:(NSString *)refreshDatePermanentKey
{
...
@implementation UICollectionView(DragRefreshAndLoadPrivate)
...
@implementation UICollectionView (DragLoadUI)

//Sub controls
- (DGActivityIndicatorView *)headerLoadingIndicator
{
...
- (DGActivityIndicatorView *)footerLoadingIndicator
{
    if (self.dragDelegate)
    {
